...
def _load_and_preprocess_video_from_webcam():
    ...
    #frame_counter_container = st.write(f"Frame Counter: 0/{max_face_count}")
    ...
    while True:
        ...
        frame_counter += 1
        frame_counter_placeholder.write(f"Frame Counter: {face_count}/{max_face_count}", key="frame_counter")
